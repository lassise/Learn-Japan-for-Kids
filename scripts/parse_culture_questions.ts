...
for (let i = 1; i <= 20; i++) {
    ...
    for (let q = 1; q <= 30; q++) {
        ...
        qIndex++; // Increment global index to cycle
        ...
        // Combine Scenario + Question for text? Or just Question?
        // User format had scenario separate. My activity model has 'question_text'.
        // I'll combine them: "Scenario. Question"
        const fullQuestionText = `${safeScenario} ${safeQuestion}`;
