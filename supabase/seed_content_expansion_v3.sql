-- EXPANSION CONTENT V3 (30 Questions for Captain Mode)
DO $$
DECLARE
    japan_id UUID;
    v1_id UUID;
...
BEGIN
    ...
    -- This cascade deletes lessons and activities.
    ...
    -- RE-GENERATE TOURIST (20 Lessons, 30 Questions each)
    FOR i IN 1..20 LOOP
        ...
        (lesson_id, 'info', 'Welcome to Lesson ' || i || '! Get ready for 30 questions.', null, 1);
