...
BEGIN
    ...
    (v_lesson_arrival_id, 'info', 'The Currency', 3, 'At the airport, John needs money. In Japan, they use the **Yen** (Â¥). It comes in coins and bills.', 'https://images.unsplash.com/photo-1590209488737-25c2765d7949?auto=format&fit=crop&w=800&q=80', NULL),

    (v_lesson_arrival_id, 'multiple_choice', 'John goes to an ATM. What money does he get?', 4, NULL, NULL, 
    '[{"id":"opt1","text":"Dollars","is_correct":false,"explanation":"Dollars are used in the USA."},{"id":"opt2","text":"Yen","is_correct":true,"explanation":"Yes! Yen (Â¥) is the money in Japan."},{"id":"opt3","text":"Euros","is_correct":false,"explanation":"Euros are used in Europe."}]'::jsonb),
